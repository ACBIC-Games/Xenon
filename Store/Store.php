...
?>
		<?php
			if ($User) {
				...
				<a href='http://social-paradise.ml/upgrades.php' border='0'><img src='http://social-paradise.ml/Images/upgrade_promo.png' width='125' border='0'></a>
				</div>
				";
				}
		...
		while ($gI = mysql_fetch_object($getItems)) {
			...
			<td style='font-size:13px;' align='left' width='100' valign='top'><a href='../Store/Item.php?ID=".$gI->ID."' border='0' style='color:black;'>
				...
				echo "
					...
					<div style='width: 100px; height: 200px; z-index: 3;  background-image: url(http://social-paradise.ml/Store/Dir/".$gI->File.");'>
					<div style='width: 100px; height: 200px; z-index: 3;  background-image: url(/Imagess/LimitedWatermark.png);'>
					</div></div>
				";
				}
				else {
					echo "<img src='http://social-paradise.ml/Store/Dir/".$gI->File."' width='100' height='200'>";
				}
				echo "
				</div>
				<b>".$gI->Name."</b>
